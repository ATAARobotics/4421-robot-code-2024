...
public class IntakeCommand extends Command{
    ...
    public void execute() {
        ...
        if (Math.abs(ty) > 0.0) {
            ...
            double translationY = -(cameraXdistanceFromNote+Constants.Subsystems.Y_CAMERA_DISTANCE_FROM_CENTER); //robot angle changing
            System.out.println("this is before TranslationY");
            double translationX = -(cameraYdistanceFromNote+Constants.Subsystems.X_CAMERA_DISTANCE_FROM_CENTER); //the robot is not going forward for now
